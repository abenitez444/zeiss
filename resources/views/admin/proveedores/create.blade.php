            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="cod_proveedor" autocomplete="off" class="form-control" id="cod_proveedor" placeholder="Numero de Proveedor..." value="{{ old('cod_proveedor') }}" required>
                    </div>
                </div>
            </div>
