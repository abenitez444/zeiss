    ...
    <script>
       $(document).ready( function () {
            ...
            var table = $('#listInvoice').DataTable({
                ...
                serverSide: true,
                ajax: {
                    'url': "<?php echo e(route('facturas.proveedores')); ?>",
                    'type': 'POST',
                    'headers': {
...
<?php echo $__env->make('admin.layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\CarlSeizz\resources\views/admin/facturas/index_proveedores.blade.php ENDPATH**/ ?>