    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="number" name="credit_days" class="form-control" id="credit_days" placeholder="Dias de Credito..." required min="0" value="<?php echo e(old('credit_days')); ?>">
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                <label for="payment_method">Metodo de Pago</label>
                <input type="text" name="payment_method" class="form-control" placeholder="Metodo de Pago..." id="payment_method" required value="<?php echo e(old('payment_method')); ?>">
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" name="way_to_pay" class="form-control" id="way_to_pay" placeholder="Forma de Pago..." required value="<?php echo e(old('way_to_pay')); ?>">
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="checkbox" name="participa" class="form-control" id="participa">
            </div>
        </div>
    </div>
...
<?php echo $__env->make('admin.layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\CarlSeizz\resources\views/admin/clientes/create.blade.php ENDPATH**/ ?>