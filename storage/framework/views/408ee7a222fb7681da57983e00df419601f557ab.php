        ...
        <div class="container">
                                ...
                                <div class="header-ctn">
                                    <div class="nav-item dropdown no-arrow mx-1">
                                        ...
                                        <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in cart-dropdown" aria-labelledby="cartDropdown">
                                            ...
                                            <div class="cart-btns">
                                                <form action="<?php echo e(route('operations.payment')); ?>" method="post" id="form">
          ...
          <div class="row">
            ...
            <div class="col-lg-3">
              ...
              <h1 class="my-4">Puntos: <span id="count"><?php echo e($puntos_cant); ?></span></h1>
              <div class="list-group">
                <a href="<?php echo e(route('operations.products', 0)); ?>" class="list-group-item">Todas</a>
                <?php $__currentLoopData = $categorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('operations.products', $category->id)); ?>" class="list-group-item"><?php echo e($category->nombre); ?></a>
                    ...
                    <?php $__currentLoopData = $productos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="card h-100">
                                <img class="card-img-top card-img-<?php echo e($product->id); ?>" src="<?php echo e((isset($imagenes[$product->id])) ?  asset('imagenes/'.$imagenes[$product->id]) : "http://placehold.it/700x400"); ?>" alt="">
                                <div class="card-body">
                                <h4 class="card-title">
                                    <a href="#" class="card-title-<?php echo e($product->id); ?>"><?php echo e($product->nombre); ?></a>
                                </h4>
                                <h5><span class="mount-<?php echo e($product->id); ?>"><?php echo e($product->puntos); ?></span> puntos</h5>
                                <p class="card-text"><?php echo e($product->descripcion); ?></p>
                                </div>
                                <div class="card-footer">
                                    <small class="text-muted">Seleccionar: <input type="checkbox" id="<?php echo e($product->id); ?>" value="<?php echo e($product->puntos); ?>"></small>
                                    <small class="text-muted">Cantidad: <input type="number" class="stock-<?php echo e($product->id); ?> stock" min="1" max="<?php echo e($product->stock); ?>" value="1" required></small>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->startSection('js_user_page'); ?>
    <script>
        var carritoFuncionalidad = function(){
                $(".product-widget").html("");
                var count = parseInt(<?php echo e($puntos_cant); ?>);
                var amount = 0;
                var items = 0;
                var stock_total = 0;
       ...
       $(document).ready( function () {
            $('#pay_products').on('click', function (event) {
                ...
                var count = 0;
                var count2 = 0;
                var count3 = parseInt(<?php echo e($puntos_cant); ?>);
...
<?php echo $__env->make('admin.layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\CarlSeizz\resources\views/admin/operations/products/index.blade.php ENDPATH**/ ?>