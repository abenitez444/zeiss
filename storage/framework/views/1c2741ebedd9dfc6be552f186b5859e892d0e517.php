...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-md-6 col-xs-12">
			...
			<form action="<?php echo e(route('clients.load.file')); ?>" method="POST"  enctype="multipart/form-data">
...
<?php echo $__env->make('admin.layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\CarlSeizz\resources\views/admin/clientes/load.blade.php ENDPATH**/ ?>