...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-md-6 col-xs-12">
			...
			<form action="<?php echo e(route('providers.load.file')); ?>" method="POST"  enctype="multipart/form-data">

				<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" id="token">

				<div class="form-group">
					<label for="imagen">Archivo excel de proveedores</label>
...
<?php echo $__env->make('admin.layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\CarlSeizz\resources\views/admin/proveedores/load.blade.php ENDPATH**/ ?>