                ...
                <table class="table table-bordered" id="listPayment" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <th>RefQAD</th>
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['isCliente','isProveedor'])): ?>
                            <th>Fecha</th>
...
<?php $__env->startSection('js_user_page'); ?>
    <script>
        $(document).ready( function () {
            <?php if($load_invoice): ?>
                route = "<?php echo e(route('pagos.admin')); ?>";
            <?php else: ?>
                route = "<?php echo e(route('pagos.other')); ?>";
            <?php endif; ?>
...
<?php echo $__env->make('admin.layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\CarlSeizz\resources\views/admin/pagos/index.blade.php ENDPATH**/ ?>