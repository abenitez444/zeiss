    ...
    <div class="container-fluid">
        ...
        <div class="row py-lg-4">
            ...
            <div class="col-md-4">
                <div class="row">
                    <div class="col-md-7">
                        <a href="<?php echo e(route('providers.create')); ?>" class="btn btn-primary btn-md float-md-right" role="button" aria-pressed="true">Crear nuevo proveedor</a>
                    </div>
                    <div class="col-md-5">
                        <a href="<?php echo e(route('providers.load')); ?>"" class="btn btn-primary btn-md float-md-right" role="button" aria-pressed="true">
                            Cargar Archivo</a>
                    </div>
                </div>
            </div>
                    ...
                    <table class="table table-bordered" id="listProvider" width="100%" cellspacing="0">
                        ...
                        <?php $__currentLoopData = $providers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><?php echo e($user->cod_proveedor); ?></td>
                                <td><?php echo e($user->nombreuser); ?></td>
                                <td><?php echo e($user->correo); ?></td>
                                <td><?php echo e($user->nombrerol); ?></td>
                                <td>
                                    <a href="<?php echo e(route('providers.show', $user->idd)); ?>" class="btn btn-info btn-circle btn-sm" ><i class="fa fa-eye"></i></a>
                                    <a href="<?php echo e(route('providers.edit', $user->idd)); ?>" class="btn btn-warning btn-circle btn-sm"><i class="fa fa-edit"></i></a>
...
<?php echo $__env->make('admin.layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\CarlSeizz\resources\views/admin/proveedores/index.blade.php ENDPATH**/ ?>