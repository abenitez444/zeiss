...
<form method="POST" action="<?php echo e(route('sellers.update', $user->user->id)); ?>" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="number" name="points" class="form-control" id="points" placeholder="Puntos..." min="0" value="<?php echo e($user->points); ?>">
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                <label for="clave">Codigo</label>
                <input type="text" name="clave" class="form-control" placeholder="Codigo Vendedor..." id="clave" required value="<?php echo e($user->clave); ?>">
            </div>
        </div>
    </div>
            ...
            <div class="form-group">
				...
				<select class='form-control mi-selector' name='client_id' required>
                    ...
                    <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value='<?php echo e($client->user->id); ?>' <?php echo e(($client->user->id == $user->client_id) ? 'selected' : ''); ?>><?php echo e($client->user->name.' - '.$client->rfc); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                ...
                <input type="text" name="address" class="form-control" placeholder="Direccion..." id="address" required value="<?php echo e($user->address); ?>">
            </div>
        </div>
    </div>
...
<?php echo $__env->make('admin.layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\CarlSeizz\resources\views/admin/sellers/edit.blade.php ENDPATH**/ ?>